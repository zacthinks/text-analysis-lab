#!/usr/bin/env python3
"""Convert the public AllenNLP BERT SRL archive into a modern BOI model bundle.
...
from text_analysis_lab._linguistics.model_resources import download_file_atomic

METADATA_NAME = "boi_srl.json"
...
def convert_archive(
    ...
    *,
    ...
    try:
        ...
        raise RuntimeError(
            "Conversion requires the development PyTorch runtime and `uv sync --extra nlp`."
        ) from exc
